...
- Name: akeneo.spec.js >> Akeneo PIM - Authentication Tests >> should successfully login with valid credentials
- Location: tests/akeneo.spec.js:46:3
...
- generic [ref=e5]:
  - generic [ref=e6]:
    ...
    - generic [ref=e9]:
      - generic [ref=e13]: Authentication request could not be processed due to a system problem.
      - generic [ref=e14]:
        - generic [ref=e15]:
          - generic [ref=e16]:
            - generic [ref=e17]: Username or Email
            - textbox "Username or Email" [active] [ref=e19]: admin
          - generic [ref=e20]:
